...
# model=pickle.load(open('C:/Users/khaiz/Documents/liscense_plate_detectionreact/backend/model_numberplate.pkl','rb'))
# model_ocr=pickle.load(open('C:/Users/khaiz/Documents/liscense_plate_detectionreact/backend/model_ocr.pkl','rb'))
model=YOLO("./backend/best.pt")
model_ocr=YOLO("./backend/best_ocr.pt")
ocr={
    0: '0',
    1: '1',
    2: '2',
...
def OCR(path,filename):
    ...
    cv2.imwrite('C:/Users/khaiz/Documents/liscense_plate_detectionreact/backend/static/upload/'+filename,image_save)
    ...
    for i in range(0,n_coord):
        ...
        cv2.imwrite('C:/Users/khaiz/Documents/liscense_plate_detectionreact/backend/static/predict_numberplate/'+str(i)+filename,image)
    ...
    # # 255 and all background pixels to 0
        ...
        cv2.imwrite('C:/Users/khaiz/Documents/liscense_plate_detectionreact/backend/static/plates/'+str(i)+filename,sharp_image)
