...
# sender_email='challansystemalpr@gmail.com'
# password='onkbcoonzjzbummd'
# message=MIMEMultipart()
# smtp_server='smtp.gmail.com'
# smtp_port=587
client=MongoClient("") #change md link
...
def register():
        try:
                ...
                y=None
                x=ccv.find_one({'lc_number':vehicalnumber})
                if(type(x)==type(y)):
...
if __name__=='__main__':
    app.run(host='192.168.220.101',debug=True)
